...
export default function Sidebar({ blocks, onOpen, activeId, getBlockPct, search, setSearch }) {
  return (
    <nav aria-label="Bloques" className="bg-white rounded-xl shadow-soft p-3 sticky top-4 h-fit">
      <div className="flex gap-2 mb-3">
        ...
        />
        <button onClick={() => setSearch('')} className="px-3 py-2 rounded-lg border">✖</button>
      </div>
